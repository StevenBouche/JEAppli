...
class UserEdit extends Component {
    ...
    async handleAction(){
        if(this.state.userrole != "" && this.state.teamId != undefined && this.state.userId != undefined && this.state.groupId != undefined){
            var res = await TeamsManager.updateUserGroupTeam(this.state.teamId, this.state.groupId, this.state.userId, this.state.userrole)
        }
